	...
	public static void main(String[] args) {
		...
		try {
			...
			DanhSachHangHoa hh = new DanhSachHangHoa();
				...
				hh.themHangHoa(new HangThucPham("789", "Lương khô", 20000.00, 35,"acer" ,LocalDate.of(2021, 11, 5), LocalDate.of(2021,11, 12)));
				...
				if(kq ==true) {
				 ...
				 System.out.println("nhập mã hàng lại: "); 
				 String maHHH = sc.nextLine();
				 ...
				 boolean tt = hh.suaDonGia(maHHH, donGia);
				 if(tt == true) {
